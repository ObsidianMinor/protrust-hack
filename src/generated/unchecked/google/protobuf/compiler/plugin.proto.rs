            ...
            crate::reflect::GeneratedCodeInfo {
                structs: ::std::option::Option::Some(::std::boxed::Box::new([
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::Version as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::CodeGeneratorRequest as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::CodeGeneratorResponse as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::Some(::std::boxed::Box::new([
                            crate::reflect::GeneratedStructInfo {
                                new: || ::std::boxed::Box::new(<self::CodeGeneratorResponse_File as crate::LiteMessage>::new()),
                                structs: ::std::option::Option::None,
                            },
                        ])),
                    },

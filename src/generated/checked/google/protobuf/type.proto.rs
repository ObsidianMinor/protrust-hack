            ...
            crate::reflect::GeneratedCodeInfo {
                structs: ::std::option::Option::Some(::std::boxed::Box::new([
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::Type as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::Field as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::Enum as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::EnumValue as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                    crate::reflect::GeneratedStructInfo {
                        new: || ::std::boxed::Box::new(<self::Option as crate::LiteMessage>::new()),
                        structs: ::std::option::Option::None,
                    },
                ])),
            }
